    ...
    <>
      ...
      >
        <Button
          ...
          className="w-14 h-14 rounded-full shadow-lg bg-gradient-to-br from-orange-500 to-red-600"
          size="lg"
        >
          {isOpen ? '✕' : '🧘‍♂️'}
        </Button>
            ...
            <Card className="h-full flex flex-col shadow-2xl">
              <CardHeader className="bg-gradient-to-r from-orange-500 to-red-600 text-white rounded-t-lg">
                <div className="flex items-center justify-between">
                  <div>
                    <CardTitle className="text-lg">AI Cultural Guide</CardTitle>
                    <p className="text-sm opacity-90">Ask a Monk • Cultural Assistant</p>
                  </div>
              ...
              <CardContent className="flex-1 flex flex-col p-0">
                ...
                <div className="p-4 border-t">
                  <div className="flex gap-2">
                    <Input
                      placeholder={language === 'english' ? "Ask about monasteries, festivals, meditation..." : "मठ, त्योहार, ध्यान के बारे में पूछें..."}
                      value={inputText}
